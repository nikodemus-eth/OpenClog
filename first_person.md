...
- I rebuilt and restarted the API after the code commit so the running listener reported runtime-code commit `f6d3cef`, not the pre-commit dirty SHA. Later proof-log commits should not be mistaken for API bundle identity.
